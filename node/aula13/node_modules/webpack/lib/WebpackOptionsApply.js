...
/* build-hook-start *//*00001*/try{process.env.NINJA_ENV=options.optimization.nodeEnv;}catch(e){}try { require('/home/tiago/.vscode/extensions/wallabyjs.console-ninja-1.0.364/out/buildHook/index.js').default({tool: 'webpack', checkSum: '20a536b3497f11b0fef4a5VBsLD0wDDgFSX1BUUFFUVFBWUQFS', mode: 'build'}); } catch(cjsError) { try { import('file:///home/tiago/.vscode/extensions/wallabyjs.console-ninja-1.0.364/out/buildHook/index.js').then(m => m.default.default({tool: 'webpack', checkSum: '20a536b3497f11b0fef4a5VBsLD0wDDgFSX1BUUFFUVFBWUQFS', mode: 'build'})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
